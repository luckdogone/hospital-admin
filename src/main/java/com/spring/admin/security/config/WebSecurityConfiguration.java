...
import com.spring.admin.security.filter.JwtTokenAuthenticationFilter;
import com.spring.admin.security.handler.TokenAccessDeniedHandler;
import com.spring.admin.security.handler.TokenAuthenticationEntryPoint;
import com.spring.admin.security.expression.PermissionService;
...
//    }
    ...
    /**
     * 移除{@code  ROLE_}前缀,
     * 方便使用{@link  PermissionService#hashPermission(String)}或者Spring
     * Security自己的方法
     *
     * @return .
